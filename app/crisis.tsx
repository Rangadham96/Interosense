...
const styles = StyleSheet.create({
  ...
  regionCardCopy: { marginBottom: 12 },
  regionCardTitle: { fontFamily: 'Nunito_700Bold', fontSize: 15, color: Colors.text },
  regionCardHint: { fontFamily: 'Nunito_400Regular', fontSize: 12, color: Colors.textSecondary, marginTop: 3 },
  regionOptions: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  regionOption: {
  ...
  regionOptionSelected: { backgroundColor: Colors.primary, borderColor: Colors.primary },
  regionOptionText: { fontFamily: 'Nunito_600SemiBold', fontSize: 12, color: Colors.textSecondary },
  regionOptionTextSelected: { color: Colors.textInverse },
